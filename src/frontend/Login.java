				...
				try {
					...
					if (remoteGame.isLoginValid(userNameArea.getText(), passString)) {
						...
						if (!remoteGame.isClientLoggedIn(userNameArea.getText())) {
							...
							JOptionPane.showMessageDialog(null, "Username has been used. Please try another username",
									"Error", JOptionPane.PLAIN_MESSAGE);
						}
					} else {
						JOptionPane.showMessageDialog(null, "Username or password not valid. Please retype again",
								"Error", JOptionPane.PLAIN_MESSAGE);
					}
