				...
				if (getPass().equals(getConfirmPass())) {
					try {
						if (remoteGame.isUsernameExisted(userNameArea.getText())) {
							...
							dispose();
							JOptionPane.showMessageDialog(null, "Registration succeful.", "Success",
					...
					JOptionPane.showMessageDialog(null, "Confirmation does not match password. Please retype again",
							"Error", JOptionPane.PLAIN_MESSAGE);
				}
